      ...
      <div className='container d-flex py-4' style={{height:"100px"}}>
        <div className='row w-100 h-100'>
            <div className='col-3 h-100'>
                <a href="/"><img src="/assets/bg/jewelry2.png" alt="" className='img-fluid h-100 w-100'/></a>
            </div>
            <div className='col-5 d-flex py-2 h-100'>
                <input type="text" placeholder='Tìm kiếm...' onChange={e=>setSearchInput(e.target.value)} className='form-control border border-2 border-danger'/>
